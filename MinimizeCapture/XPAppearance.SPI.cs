...
namespace KLCProxy
{
    static partial class XPAppearance {
        ...
        private enum SPI : uint {
            ...
            //#if(WINVER >= 0x0400)
            /// <summary>
            /// Sets dragging of full windows cher on or off. The uiParam parameter specifies TRUE for on, or FALSE for off. 
            ...
            /// <summary>
            /// Sets active window tracking (activating the window the mouse is on) cher on or off. Set pvParam to TRUE for on or FALSE for off.
            /// Windows NT, Windows 95:  This value is not supported.
            /// </summary>
            ...
            /// <summary>
            /// Sets the font smoothing type. The pvParam parameter points to a UINT that contains cher FE_FONTSMOOTHINGSTANDARD, 
